...
const editorPath = path.resolve(__dirname, process.argv[2] || require.resolve('telestoworld-ecs/artifacts/editor'))
const targetEditorPath = path.resolve(__dirname, '../public/editor.js')

const ecsPath = path.resolve(__dirname, process.argv[3] || require.resolve('telestoworld-ecs/dist/src/index.js'))
